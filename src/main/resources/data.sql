...
В купа сложете нарязаното пиле, добавете и ситно нарязаните яйца, както и ситно нарязания лук. Добавете лимоновия сок и 1.5 чаена лъжица сол, както и черния пипер и разбъркайте. След това добавете майонезата и горчицата и отново разбъркайте.', 0, 30, '2022/01/02', true, 1),
...
Поднасяте супата гореща, като към всяка купичка добавяте нарязан пресен магданоз и бучка краве масло.', 2, 30, '2022/01/02', true, 1),
...
Добавете червения пипер и 1 чаена лъжица сол, добавете и почистените и нарязано на ситно домати, и оставете ястието да ври на слаб огън. След около 5-10 минути телешкото с грах ще е готово.', 2, 0, '2022/01/03', true, 1),
...
В единия край на изпечените тиквени филийки слагате част от сместа, завивате на колелце, след което го забучвате с клечка за зъби, за да се фиксира и да не се развива.', 0, 30, '2022/02/19', true, 1),
...
Салатата Ропотамо може да бъде сервирана и консумирана на момента, може да я съхранявате в хладилника за 3-4 дни, а може и да я сложите в бурканчета, които да стерилизирате за 15-20 минути.', 0, 30, '2022/02/19', true, 1),
       ('10', 'ДОМАТЕНА КРЕМ СУПА С ФИДЕ', 'КРЕМ СУПА', true, 4, 'Накълцайте на дребно лука, което може да направите и с блендер/кухненски робот. Накълцаният лук, заедно с натрошеното на ситно фиде запържвате в маслото, докато фидето придобие златист цвят.
...
Тук е моменът да сложите сол на доматената супичка. И малко захар, за да не бъде много кисела. Накрая добавяте и млякото, което не трябва да е току-що излязло от хладилника, а да е леко затоплено, поне на стайна температура. И след само 15 мин варене имате чудесна  доматена крем-супа!', 0, 30, '2022/02/19', true, 1),
...
Намажете форма за кекс с мазнина и изсипете готовата смес за козуначен кекс. Сложете кекса в студена фурна, след което я включете на 160 градуса. Така тестото ще втаса, докато фурната се загрява. Печете около 30-40 минути, до придобиване на апетитен златист цвят.', 1, 10, '2022/02/19', true, 1),
...
Ябълковата пълнка приготвяне, като оставите обелените и нарязани на ситно ябълки, заедно със захарта, канелата, кардамона и рома да заврат за няколко минути, като разбърквате от време на време. След като ябълките се сготвят, махате шушулките кардамон и пръчките канела, оставете сместа на страни, за да изстине.', 1, 0, '2022/02/19', true, 1),
...
Измивате лука и доматите и ги нарязвате на дребно. Авокадото също нарязвате на кубчета и ги добавяте в купата към макароните. Добавяте около ½ чаена лъжица сол както и предвиденото количество зехтин и балсамов оцет и разбърквате добре с лъжица, така че салатата да се овкуси добре.', 0, 30, '2022/02/19', true, 1);
