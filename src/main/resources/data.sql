...
Добавете червения пипер и 1 чаена лъжица сол, добавете и почистените и нарязано на ситно домати, и оставете ястието да ври на слаб огън. След около 5-10 минути телешкото с грах ще е готово.', 2, 0, '2022/01/03', 1, 1),
       ('8', 'РОЛЦА ОТ ТИКВИЧКИ С КРЕМ СИРЕНЕ', 'ПРЕДЯСТИЕ', 1, 8, 'Първата стъпка от рецептата за ролца от тиквички с крем сирене е изборът и подготовката на тиквичките. Избирате средно големи тиквички. Измивате ги, отрязвате двата им края и ги нарязвате на тънки филийки по дължина. На оребрен тиган, на скара или на грил изпичате тиквичките от двете страни, слагате ги в купа, като ги овкусявате с ½ чаена лъжица сол, зехтина и оцета.
...
В единия край на изпечените тиквени филийки слагате част от сместа, завивате на колелце, след което го забучвате с клечка за зъби, за да се фиксира и да не се развива.', 0, 30, '2022/02/19', 1, 1),
       ('9', 'САЛАТА РОПОТАМО', 'САЛАТА', 1, 10, 'Първата стъпка от рецептата за салата Ропотамо е подготовката на боба и чушките. Добруджанският шарен боб Статев подготвяте, както всеки път когато готвите боб. Заливате с вода и оставяте да престои за няколко часа или за една нощ. Изливате водата, наливате нова и слагате отново да заври, а след завиране я изсипвате и наливате нова. Варите до пълно сваряване. Може да ползвате и боб от консерва, така може да прескочите тази стъпка. Чушките изпичате, обелвате ги и ги нарязвате.
...
Салатата Ропотамо може да бъде сервирана и консумирана на момента, може да я съхранявате в хладилника за 3-4 дни, а може и да я сложите в бурканчета, които да стерилизирате за 15-20 минути.', 0, 30, '2022/02/19', 1, 1),
       ('10', 'ДОМАТЕНА КРЕМ СУПА С ФИДЕ', 'КРЕМ СУПА', 1, 4, 'Накълцайте на дребно лука, което може да направите и с блендер/кухненски робот. Накълцаният лук, заедно с натрошеното на ситно фиде запържвате в маслото, докато фидето придобие златист цвят.
...
Тук е моменът да сложите сол на доматената супичка. И малко захар, за да не бъде много кисела. Накрая добавяте и млякото, което не трябва да е току-що излязло от хладилника, а да е леко затоплено, поне на стайна температура. И след само 15 мин варене имате чудесна  доматена крем-супа!', 0, 30, '2022/02/19', 1, 1),
       ('11', 'ПУХКАВ МНОГОЦВЕТЕН КРЕМ', 'КРЕМ', 1, 12, 'Първата стъпка от рецептата за пухкав многоцветен крем е подготовката на кондензираното мляко. Трябва да варите кутията кондензирано мляко за около 2 часа, за да се сгъсти. Спокойно можете да направите това и предишния ден. А ако имате под ръка дулче де лече, използвайте него, вместо да варите кондензираното мляко. Докато варите кондензираното мляко, подгответе останалите продукти. Смилате какаовите бисквити и добавяте към тях кравето масло, което предварително разтопявате, разбърквате добре, за да се получат маслени трохи.
...
Намажете форма за кекс с мазнина и изсипете готовата смес за козуначен кекс. Сложете кекса в студена фурна, след което я включете на 160 градуса. Така тестото ще втаса, докато фурната се загрява. Печете около 30-40 минути, до придобиване на апетитен златист цвят.', 1, 10, '2022/02/19', 1, 1),
       ('13', 'МАСЛЕН СЛАДКИШ С ЯБЪЛКИ И КРЕМ', 'СЛАДКИШ', 1, 14, 'Първата стъпка от рецептата за маслен сладкиш с ябълки и крем е подготовката на тестото. Смесвате брашното, заедно с бакпулвера в купа, след което добавяте захарта, която сте разбили заедно с яйцата и ванилията. В купата добавяте и маста, и замесвате тесто. Спокойно, вместо свинска мас можете да използвате и краве масло. Готовото тесто приберете в хладилника, докато приготвяте двата вида плънка.
...
Измивате лука и доматите и ги нарязвате на дребно. Авокадото също нарязвате на кубчета и ги добавяте в купата към макароните. Добавяте около ½ чаена лъжица сол както и предвиденото количество зехтин и балсамов оцет и разбърквате добре с лъжица, така че салатата да се овкуси добре.', 0, 30, '2022/02/19', 1, 1);
...
VALUES ('1', '../../cook_images/fit_1400_933', 1),
       ('2', '../../cook_images/fit_1400_934', 1),
       ('3', '../../cook_images/fit_1400_935', 1),
       ('4', '../../cook_images/fit_1400', 2),
       ('5', '../../cook_images/fit_1400_93', 2),
       ('6', '../../cook_images/fit_1400_9', 2),
       ('7', '../../cook_images/fit', 3),
       ('8', '../../cook_images/fit_1', 3),
       ('9', '../../cook_images/fit_2', 3),
       ('10', '../../cook_images/f', 4),
       ('11', '../../cook_images/fijpg', 4),
       ('12', '../../cook_images/fir', 4),
       ('13', '../../cook_images/teleshko', 5),
       ('14', '../../cook_images/teleshko2', 5),
       ('15', '../../cook_images/feee', 6),
       ('16', '../../cook_images/feejpg', 6),
       ('17', '../../cook_images/fe', 6),
       ('18', '../../cook_images/a', 7),
       ('19', '../../cook_images/aa', 7),
       ('20', '../../cook_images/aaa', 7),
       ('21', '../../cook_images/rolca', 8),
       ('22', '../../cook_images/rolca2', 8),
       ('23', '../../cook_images/ropotamo', 9),
       ('24', '../../cook_images/ropotamo2', 9),
       ('25', '../../cook_images/ropotamo3', 9),
       ('26', '../../cook_images/domatena', 10),
       ('27', '../../cook_images/domatena2', 10),
       ('28', '../../cook_images/krem', 11),
       ('29', '../../cook_images/krem2', 11),
       ('30', '../../cook_images/krem3', 11),
       ('31', '../../cook_images/keks', 12),
       ('32', '../../cook_images/keks2', 12),
       ('33', '../../cook_images/keks3', 12),
       ('34', '../../cook_images/sladkish', 13),
       ('35', '../../cook_images/sladkish2', 13),
       ('36', '../../cook_images/piroshki', 14),
       ('37', '../../cook_images/piroshki2', 14),
       ('38', '../../cook_images/pasta', 15),
       ('39', '../../cook_images/pasta2', 15),
       ('40', '../../cook_images/ps', 16),
       ('41', '../../cook_images/ps2', 16),
       ('42', '../../cook_images/ps3', 16);

INSERT INTO `ingredient` (`id`, `name`, `measure_unit`, `quantity`, `recipe_id`)
VALUES ('1', 'прясно мляко', 'л.', 1, 1),
       ('2', 'маскарпоне', 'гр.', 500, 1),
       ('3', 'захар', 'с.л.', 4, 1),
       ('4', 'бисквити Закуска', 'гр.', 330, 1),
       ('5', 'пудинг', 'бр.', 2, 1),
       ('6', 'пудра захар', 'с.л.', 2, 1),
       ('7', 'бейлис', 'ч.ч.', 2.5, 1),
       ('8', 'мармалад', 'ч.ч.', 1, 1),
       ('9', 'точени кори', 'гр.', 400, 2),
       ('10', 'яйца', 'бр.', 3, 2),
       ('11', 'ванилии', 'бр.', 1, 2),
       ('12', 'пудра захар', 'с.л.', 1, 2),
       ('13', 'прясно мляко', 'мл.', 500, 2),
       ('14', 'захар', 'ч.ч.', 1, 2),
       ('15', 'краве масло', 'гр.', 120, 2),
       ('16', 'фурми', 'бр.', 10, 3),
       ('17', 'банан', 'бр.', 3, 3),
       ('18', 'мед', 'с.л.', 1, 3),
       ('19', 'стафиди', 'гр.', 50, 3),
       ...
       ('21', 'бадеми', 'гр.', 250, 3),
       ('22', 'какао', 'с.л.', 3, 3),
       ('23', 'кокосови стърготини', 'ч.ч.', 1, 3),
       ('24', 'чия', 'с.л.', 2, 3),
       ('25', 'яйца', 'бр.', 8, 4),
       ('26', 'лук', 'бр.', 1, 4),
       ('27', 'горчица', 'с.л.', 3, 4),
       ('28', 'черен пипер', 'щипка', 1, 4),
       ('29', 'пилешко месо', 'гр.', 200, 4),
       ('30', 'майонеза', 'гр.', 200, 4),
       ('31', 'лимонов сок', 'с.л.', 3, 4),
       ('32', 'телешки джолан', 'бр.', 1, 5),
       ('33', 'моркови', 'гр.', 300, 5),
       ('34', 'домати', 'гр.', 200, 5),
       ('35', 'краве масло', 'гр.', 40, 5),
       ('36', 'оцет', 'с.л.', 1, 5),
       ('37', 'картофи', 'гр.', 300, 5),
       ('38', 'целина', 'гр', 150, 5),
       ('39', 'лук', 'гр.', 300, 5),
       ('40', 'черен пипер', 'щипка', 1, 5),
       ('41', 'магданоз', 'стрък', 1, 5),
       ('42', 'яйца', 'бр.', 3, 6),
       ('43', 'бакпулвер', 'ч.л.', 1.5, 6),
       ('44', 'крема сирене', 'с.л.', 3, 6),
       ('45', 'телешко месо', 'гр', 500, 7),
       ('46', 'лук', 'бр.', 2, 7),
       ('47', 'домати', 'бр.', 3, 7),
       ('48', 'червен пипер', 'щипка', 1, 7),
       ('49', 'грах', 'гр.', 800, 7),
       ('50', 'моркови', 'бр.', 2, 7),
       ('51', 'олио', 'ч.ч.', 1.5, 7),
       ('52', 'тиквички', 'бр.', 3, 8),
       ('53', 'чесън', 'скилитки.', 3, 8),
       ('54', 'копър', 'връзка.', 1.5, 8),
       ('55', 'зехтин', 'с.л.', 2, 8),
       ('56', 'крем сирене', 'гр.', 150, 8),
       ('57', 'орехи', 'бр.', 3, 8),
       ('58', 'оцет', 'с.л.', 2, 8),
       ('59', 'боб', 'гр.', 250, 9),
       ('60', 'грах', 'гр.', 250, 9),
       ...
       ('63', 'сол', 'с.л.', 2, 9),
       ('64', 'чушки', 'кг.', 1, 9),
       ('65', 'кисели краставички', 'бр.', 6, 9),
       ('66', 'доматено пюре', 'ч.ч.', 1, 9),
       ('67', 'олио', 'ч.ч.', 1.5, 9),
       ('68', 'захар', 'с.л.', 2, 9),
       ('69', 'домати', 'кг.', 1, 10),
       ('70', 'фиде', 'гр.', 30, 10),
       ('71', 'захар', 'к.л.', 1, 10),
       ('72', 'лук', 'глава', 1, 10),
       ('73', 'прясно мляко', 'гр.', 150, 10),
       ('74', 'бисквити', 'гр.', 300, 11),
       ('75', 'мляко', 'гр.', 400, 11),
       ('76', 'малини', 'гр.', 500, 11),
       ('77', 'течен шоколад', 'гр.', 200, 11),
       ('78', 'лешници', 'гр.', 100, 11),
       ('79', 'краве масло', 'гр.', 120, 11),
       ('80', 'сладкарска сметана', 'мл.', 200, 11),
       ('81', 'захар', 'ч.ч', 1.5, 11),
       ('82', 'маскарпоне', 'гр.', 200, 11),
       ('83', 'яйца', 'бр.', 3, 12),
       ('84', 'прясно мляко', 'ч.ч.', 1, 12),
       ('85', 'мая', 'гр.', 7, 12),
       ('86', 'брашно', 'ч.ч.', 3, 12),
       ('87', 'краве масло', 'ч.ч.', 1.5, 12),
       ('88', 'захар', 'ч.ч.', 1, 12),
       ('89', 'сол', 'ч.л.', 1.5, 12),
       ('90', 'локум', 'гр.', 100, 12),
       ('91', 'свинска мас', 'ч.ч.', 1, 13),
       ('92', 'захар', 'ч.ч.', 1, 13),
       ('93', 'бакпулвер', 'ч.л.', 2, 13),
       ('94', 'прясно мляко', 'мл.', 500, 13),
       ('95', 'брашно', 'ч.ч.', 4, 13),
       ('96', 'ябълки', 'гр.', 500, 13),
       ('97', 'ром', 'с.л.', 3, 13),
       ('98', 'кардамон', 'бр.', 2, 13),
       ...
       ('100', 'ванилия', 'бр.', 3, 13),
       ('101', 'канела', 'бр.', 2, 13),
       ('102', 'суха мая', 'гр', 7, 14),
       ('103', 'захар', 'ч.л.', 2, 14),
       ('104', 'олио', 'ч.ч.', 1.5, 14),
       ('105', 'картофи', 'гр.', 300, 14),
       ('106', 'брашно', 'гр.', 500, 14),
       ('107', 'сол', 'ч.л.', 1, 14),
       ('108', 'вода', 'ч.ч.', 1, 14),
       ('109', 'лук', 'бр.', 1, 14),
       ('110', 'черен пипер', 'ч.л.', 1.5, 14),
       ('111', 'домати', 'кг.', 1, 15),
       ('112', 'босилек', 'листа', 20, 15),
       ('113', 'спагети', 'гр.', 300, 15),
       ('114', 'чесън', 'скилидки', 5, 15),
       ('115', 'зехтин', 'с.л.', 3, 15),
       ('116', 'пармезан', 'гр.', 20, 15),
       ('117', 'макарони', 'gr.', 200, 16),
       ('118', 'авокадо', 'бр.', 1, 16),
       ('119', 'пресен лук', 'бр.', 3, 16),
       ('120', 'оцет', 'с.л.', 1, 16),
       ('121', 'домати', 'гр.', 200, 16),
       ('122', 'пилешко месо', 'гр.', 200, 16),
       ('123', 'зехтин', 'с.л.', 3, 16);