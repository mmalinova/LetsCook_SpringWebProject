...
INSERT INTO `recipe` (`id`, `name`, `subcategory`, `vegetarian`, `portions`, `steps`, `hours`, `minutes`, `created_on`, `approved`, `ingredients`, `owner_id`)
...
Поднасяте супата гореща, като към всяка купичка добавяте нарязан пресен магданоз и бучка краве масло.', 2, 30, '2022/01/02', true, 'телешки джолан, моркови, домати, краве масло, оцет, картофи, целина, лук, черен пипер, магданоз', 1),
...
Добавете червения пипер и 1 чаена лъжица сол, добавете и почистените и нарязано на ситно домати, и оставете ястието да ври на слаб огън. След около 5-10 минути телешкото с грах ще е готово.', 2, 0, '2022/01/03', true, 'телешко месо, лук, домати, червен пипер, грах, моркови, олио', 1),
...
В единия край на изпечените тиквени филийки слагате част от сместа, завивате на колелце, след което го забучвате с клечка за зъби, за да се фиксира и да не се развива.', 0, 30, '2022/02/19', true, 'тиквички, чесън, копър, зехтин, крем сирене, орехи, оцет', 1),
...
Салатата Ропотамо може да бъде сервирана и консумирана на момента, може да я съхранявате в хладилника за 3-4 дни, а може и да я сложите в бурканчета, които да стерилизирате за 15-20 минути.', 0, 30, '2022/02/19', true, 'боб, грах, моркови, оцет, сол, чушки, кисели краставички, доматено пюре, олио, захар', 1),
...
Ябълковата пълнка приготвяне, като оставите обелените и нарязани на ситно ябълки, заедно със захарта, канелата, кардамона и рома да заврат за няколко минути, като разбърквате от време на време. След като ябълките се сготвят, махате шушулките кардамон и пръчките канела, оставете сместа на страни, за да изстине.', 1, 0, '2022/02/19', true, 'свинска мас, захар, бакпулвер, прясно мляко, брашно, ябълки, ром, кардамон, яйца, ванилия, канела', 1),
